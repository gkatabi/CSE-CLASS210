...
// Outer class
    ...
    // Inner class
        ...
        // Static method of Inner class
            ...
            string street = Console.Write( "Name of your street: ") ;
            address = Console.ReadLine();
            string city = Console.Write("City: ");
            ...
            Console.WriteLine(Video_class.identity);
            Console.WriteLine(Video_class.house);
            Console.WriteLine(Video_class.street);
            Console.WriteLine( Video_class.city  );
            Console.WriteLine( Video_class.country );
            Console.WriteLine(Video_class.comment);
            }
        }
    }
    public class Video_second
    {
 
    // Static data member of the video class
        public  string tittle = "Red wolf";
        public string author ="Johnson moy";
...
// Driver Class
    ...
    // Main method
        ...
        // of the inner class
            ...
            Video_class.video_second.method2();
            Video_class.Video_third.method3();
